...
public:
	...
	Codemon(std::string nome,int id,int tipo,int livello,int nMosseI,int attacco,int difesa,int attaccoX,int difesaX,int velocita,int precisione,int stadio,int hpM){
		this->nome = nome;
		this->id = id;
		this->tipo = tipo;
